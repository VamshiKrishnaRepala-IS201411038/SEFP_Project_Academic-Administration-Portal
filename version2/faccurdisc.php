...
$sql = "select courses.cid,courses.cname,faculty.name from courses,faculty where faculty.fid = courses.fid and courses.fid=
$usr_id;";
...
$t = 0;
    while($row = $result->fetch_assoc()) {
        ...
        echo "<tr><td><center><a href=current.php?cid=$row[cid]>"."$row[cname]"."</center></td> </tr>";
        echo "<br>";
    }
} else {
  $t = 1;
