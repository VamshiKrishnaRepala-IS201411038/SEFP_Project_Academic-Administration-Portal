...
$sql = "select courses.cid,courses.cname,faculty.name from courses,faculty where faculty.fid = courses.fid;";
...
$t = 0;
    while($row = $result->fetch_assoc()) {
        ...
        echo "<tr><td><center><a href=display_attendance2.php?cid=$row[cid]>"."$row[cname]"."</center></td><td><center>"."$row[name]"."</center></td> </tr>";
        echo "<br>";
    }
} else {
  $t = 1;
